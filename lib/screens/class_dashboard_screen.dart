...
class _ClassDashboardScreenState extends State<ClassDashboardScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildInsightsTab() {
    // Basic insights for the teacher or student
    return SingleChildScrollView(
      padding: const EdgeInsets.all(20),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      _buildInsightStatistic(
                        label: widget.isTeacher ? 'Students' : 'Assignments',
                        value: widget.isTeacher ? widget.classModel.studentCount.toString() : '0',
                        icon: widget.isTeacher ? Icons.people : Icons.assignment,
                      ),
                      _buildInsightStatistic(
                        label: 'Avg. Score',
                        value: '0%',
                ...
                child: Column(
                  ...
                  children: [
                    Icon(
                      Icons.bar_chart,
                      size: 48,
                      color: classPrimaryColor.withOpacity(0.5),
                    ),
                    const SizedBox(height: 16),
                    const Text(
                      'Score Distribution',
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'Charts will appear when students submit assignments',
                      style: TextStyle(
                        color: Colors.grey.shade600,
                        fontSize: 14,
                      ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'Activity data will appear as students engage with the class',
                      style: TextStyle(
                        color: Colors.grey.shade600,
                        fontSize: 14,
                      ),
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Invite students to join your class to view analytics and insights',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: Colors.grey.shade600,
                        ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Charts will appear when you submit assignments',
                    style: TextStyle(
                      color: Colors.grey.shade600,
                      fontSize: 14,
                    ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    const Text(
                      'AI analysis of your work will appear here after you submit assignments. Get personalized feedback and improvement suggestions.',
                      style: TextStyle(
                        fontSize: 14,
                        color: Colors.black87,
                      ),
                    ...
                    Align(
                      ...
                      child: OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          foregroundColor: classPrimaryColor,
                          side: BorderSide(color: classPrimaryColor),
                        ),
                        child: const Text('Check AI Insights'),
                      ),
                    ),
                  ],
                ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  const Text(
                    'AI suggestions for improving class engagement and student performance',
                    style: TextStyle(
                      fontSize: 14,
                      color: Colors.black87,
                    ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                widget.isTeacher
                                    ? 'Consider adding more interactive content to increase student engagement.'
                                    : 'Try to explain concepts to others to reinforce your understanding.',
                                style: const TextStyle(
                                  fontWeight: FontWeight.w500,
                                  fontSize: 14,
                                ),
